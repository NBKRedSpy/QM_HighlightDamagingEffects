...
The configuration file will be created on the first game run and can be found at [i]%AppData%\..\LocalLow\Magnum Scriptum Ltd\Quasimorph\QM_HighlightDamagingEffects\config.json[/i].
[table]
[tr]
[td]Name
[/td]
